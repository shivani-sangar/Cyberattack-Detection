	...
	def fine_tuning(self, sess, train_set_x, batch_size = 10 , training_epochs = 1000 , learning_rate = 0.1, display_step = 1):
		...
		for epoch in range(training_epochs):
			...
			if epoch % display_step == 0:
				...
				with open("unsw_output.csv", "a", newline='') as csv_file:
...
if __name__ == "__main__":
	...
	filename2 = dir_path + "/datasets/UNSW_NB15/UNSW_NB15_testing-set.csv"
	filename1 = dir_path + "/datasets/UNSW_NB15/UNSW_NB15_training-set.csv"
